            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                ...
                <p className="text-base sm:text-lg text-slate-700 leading-relaxed font-medium">
                  If your child struggles with handwriting, gets overwhelmed by everyday sounds or textures, has trouble with buttons and zippers, or seems clumsier than other kids their age, an occupational therapist can help. At <strong>Hand in Hand Therapy Centre</strong>, our occupational therapy program is delivered by a team that also works closely with our registered{" "}
