...
export default function EntryPortal() {
  ...
  return (
    <section className="h-screen max-h-screen w-full bg-gradient-to-b from-[#0F2530] via-[#1B3B48] to-[#142E28] text-white flex flex-col justify-between py-6 px-4 sm:px-6 lg:px-8 relative overflow-hidden select-none">
      ...
      <div className="max-w-6xl mx-auto w-full my-auto z-10 py-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 items-stretch max-w-5xl mx-auto">
          ...
          {/* Card 01: Therapy Centre Door (Sage & Coral Accent) */}
          <Link
            href="/therapy"
          ...
          {/* Card 02: The Next Level Door (Forest Green & Organic Gold Accent) */}
          <Link
            href="/adult-program"
