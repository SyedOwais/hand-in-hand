    ...
    <section className="py-20 bg-gradient-to-b from-[#0F2530] to-[#142E28] text-white relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="mb-14">
          <Link
            href="/contact"
            className="inline-flex items-center gap-3 px-9 py-4 rounded-full text-lg font-black text-white bg-[#F57A54] hover:bg-[#E3643E] shadow-2xl transition-all transform hover:-translate-y-1"
          >
